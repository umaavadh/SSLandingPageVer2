...
**Note**: You can also use OpenAI by setting `OPENAI_API_KEY` instead, but you'll need to modify the edge function accordingly.
...
**NOTE**: In WebContainer environments (like this demo), the Gemini integration uses mock data for demonstration purposes. For production deployment with real Gemini integration, follow the setup instructions below.
